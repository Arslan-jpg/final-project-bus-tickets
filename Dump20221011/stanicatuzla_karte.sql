...
CREATE TABLE `karte` (
  ...
  `voznjaFK` int NOT NULL,
  `ime` varchar(45) DEFAULT NULL,
  `povratna` tinyint DEFAULT '0',
  PRIMARY KEY (`idkarte`),
  KEY `voznja_idx` (`voznjaFK`),
  CONSTRAINT `voznja` FOREIGN KEY (`voznjaFK`) REFERENCES `voznja` (`idvoznja`)
...
INSERT INTO `karte` VALUES (3,87,'',0),(4,89,'',0),(5,91,'',0),(6,194,'',0),(7,194,'Arslan',0),(8,282,'',0),(9,356,'',0);
